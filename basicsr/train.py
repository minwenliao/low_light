...
# os.environ["CUDA_VISIBLE_DEVICES"] = '0'  #表示用几号GPU  5号机“0卡”好跑去噪
# os.environ["CUDA_VISIBLE_DEVICES"] = '0'  #表示用几号GPU  5号机“0卡”好跑lightSR
os.environ["CUDA_VISIBLE_DEVICES"] = '1'  #表示用几号GPU
...
setproctitle.setproctitle('code')#进程中显示名字
