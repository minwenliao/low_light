...
#由于DIV2K dataset比较大，作者将其转化为lmdb文件（将训练集转换为lmdb文件）。
...
def create_lmdb_for_sidd():
    """Create lmdb files for DIV2K dataset.
     这里制作数据集需要一个一个的制作，一起制作好像有问题
    """
    ####--------------------训练集---------------------####
    # groundtruth images     /home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/train/groundtruth

    # folder_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/train/groundtruth'
    # lmdb_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/train/groundtruth.lmdb'
    # img_path_list, keys = prepare_keys_sidd(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # input images   /home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/train/input

    # folder_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/train/input'
    # lmdb_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/train/input.lmdb'
    # img_path_list, keys = prepare_keys_sidd(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    ####--------------------训练集---------------------####

    ####--------------------测试集---------------------####
    # groundtruth images   /home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/val/groundtruth
    folder_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/val/groundtruth'
    lmdb_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/val/groundtruth.lmdb'
    img_path_list, keys = prepare_keys_sidd(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # input images   /home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/val/input
    folder_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/val/input'
    lmdb_path = '/home/l/data_2/pgw/NAFNet-main/datasets/SIDD32000/val/input.lmdb'
    img_path_list, keys = prepare_keys_sidd(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    ####--------------------测试集---------------------####
